...
@Assets(
        state = @State(name = "%s_verticalslab", template = "parent_verticalslab"),
        item = @Model(name = "item/%s_verticalslab", parent = "block/%s_verticalslab", template = "item/parent_verticalslab"),
        block = {
                @Model(name = "block/%s_verticalslab", template = "block/parent_verticalslab"),
        }
)
public class VerticalSlab extends BlockHorizontal implements IBucketPickupHandler, ILiquidContainer {
